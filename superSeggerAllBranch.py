...
imagepath = r'J:\Images\051116_all_branch_pdf'
...
#            ax = fig.add_subplot(111)
            ...
            timepoints = (np.linspace(0, len(mcherry_shift_all1[i][j][k]) - 1, len(mcherry_shift_all1[i][j][k]))*5)/60
            
            ax1.plot(timepoints, mcherry_shift_all1[i][j][k], ls = '-', marker = '', color = sb[4], alpha = 1)
            ax2.plot(timepoints, venus_shift_all1[i][j][k], ls = '-', marker = '', color = sb[3], alpha = 1)
